...
main() {
  ...
  readonly show_window_in_window_status_current="#[fg=$thm_bg,bg=$thm_yellow] #I#[fg=$thm_yellow,bg=$thm_bg]$left_separator#[fg=$thm_fg,bg=$thm_bg,nobold,nounderscore,noitalics]#[fg=$thm_fg,bg=$thm_gray] #W "

  local show_user
  readonly show_user="#[fg=$thm_cyan,bg=$thm_gray]$right_separator#[fg=$thm_bg,bg=$thm_cyan] #[fg=$thm_fg,bg=$thm_gray] #(whoami) "

  local show_host
  readonly show_host="#[fg=$thm_magenta,bg=$thm_gray]$right_separator#[fg=$thm_bg,bg=$thm_magenta]󰒋 #[fg=$thm_fg,bg=$thm_gray] #H "
