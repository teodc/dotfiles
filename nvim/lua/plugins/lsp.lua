...
return {
  ...
  },
  {
    ...
    -- Provide basic, default Nvim LSP client configurations for various LSP servers
    ...
    config = function()
      ...
      vim.api.nvim_create_autocmd('LspAttach', {
        ...
        callback = function(event)
          ...
          map('<leader>n', vim.lsp.buf.hover, 'Hover Documentation')
      ...
      local servers = {
        ...
        --     pylsp = {
        --       plugins = {
        --         -- Disable pylsp's linting as we want Ruff to take care of this
